...
//print_r($_POST);exit();
 ...
 require_once "recaptchalib.php";
   ...
   // your secret key
   $secret = "6Le18w0iAAAAAKh9dv-VMz4FqR9qgfiaR4nQcxT8";
...
if($error=="")
{
    ...
    require 'PHPMailer/PHPMailerAutoload.php';
        ...
        $mail->Password = 'kkonodhbqktrkimd';                           // SMTP password
        $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 465;                                    // TCP port to connect to
      //  $mail->Port = 587;                                    // TCP port to connect to

        $mail->From = 'maniveersticker@gmail.com';
        $mail->FromName ='maniveersticker@gmail.com';
		$mail->addAddress('maniveersticker@gmail.com'); 
       ...
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Maniveer Sticker Shopee';
        $mail->isHTML(true);
